...
//
//     final saladTimeModel = saladTimeModelFromJson(jsonString);

import 'dart:convert';

SaladTimeModel saladTimeModelFromJson(String str) => SaladTimeModel.fromJson(json.decode(str));

String saladTimeModelToJson(SaladTimeModel data) => json.encode(data.toJson());

class SaladTimeModel {
  int? code;
  String? status;
  List<Datum>? data;
  ...
  factory SaladTimeModel.fromJson(Map<String, dynamic> json) => SaladTimeModel(
    code: json["code"],
    status: json["status"],
